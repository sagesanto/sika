...
from sika.config.paths import logging_config_path, logging_config_path_nofile, logging_dir

def configure_logger(name, log_dir=None, write_to_file=True):
    """Get a logger.
    ...
    :param write_to_file: whether to write logs to a file. Default True. If False, only logs to console.
    ...
    if write_to_file:
        ...
        log_cfg_path = logging_config_path_nofile
    ...
    try:
        with open(log_cfg_path, 'r') as log_cfg:
