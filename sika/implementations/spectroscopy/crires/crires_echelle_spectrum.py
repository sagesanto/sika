...
class CRIRESEchelleSpectrum(EchelleSpectrum):
    ...
    def __init__(self, wlen:np.ndarray, flux:np.ndarray, errors:np.ndarray,
        ...
        :param filter_type: _description_, defaults to 'median'
        :type filter_type: str, optional
        :param filter_size: _description_, defaults to 100
        ...
        metadata['continuum_subtracted'] = dict(filter_type=filter_type, filter_size=filter_size, bp_sigma=bp_sigma)
