...
Key features:
   ...
   - Capable of robust, convenient multidimensional parameter fitting with dynesty, pymultinest, and emcee
...
# WIP
sika documentation is largely complete but more guides are being written. This will be updated when the docs are hosted online - right now those brave enough can be build them in their immature form from the docs folder of this repository.
